...
public class Main {
    ...
    /*
     * @param MyFirstThread - class in the program for all the
    ...
    public static void main(String[] args) throws IOException {
         ...
         *                        from needed date.
         *
         * @return - results of checkup by dates.
         */
        ...
        /*
         * @param LocalDateTime finish1 - an immutable date-time object.
         *
         ...
         *                        that find all the ERROR logs from
         *                        needed date.
         *
         * @return - results of checkup by dates.
         */
        ...
        /*
         * @param LocalDateTime finish2 - an immutable date-time object.
         *
         * @return - indicates the finishing time of operation.
         */
